# Usage : python amazon_ocr.py -i images/xxx.jpg
# ref1-PyImageSearch : https://pyimagesearch.com/2022/03/21/text-detection-and-ocr-with-amazon-rekognition-api/
# ref2-AWS : https://docs.aws.amazon.com/rekognition/latest/dg/text-detecting-text-procedure.html
